...
def main():
    ...
    # [1] Path settings
    # =========================================================
    base_folder = "/scratch2/[SC_LAB]/dreamyou070/dataset/OmniEdit"
    source_image_folder = os.path.join(base_folder, "source")
    prompt_folder = os.path.join(base_folder, "instruction")
    result_folder = "/scratch2/[SC_LAB]/dreamyou070/Neurips_MultimodalBiased/Step1_DataCuration/model2_qwen_2509/OmniEdit_Result"

    config_path = "/lustre/dreamyou070/DiTInductiveBias/EditReward/EditReward/config/EditReward-MiMo-VL-7B-SFT-2508.yaml"
    checkpoint_path = "/scratch2/[SC_LAB]/models/EditReward/EditReward-MiMo-VL-7B-SFT-2508"
