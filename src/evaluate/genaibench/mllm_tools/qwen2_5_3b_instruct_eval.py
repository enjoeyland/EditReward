...
class Qwen2_5_32B_Instruct():
    support_multi_image = True
    merged_image_files = []
    
    def __init__(self, model_path: str = "qwen2.5-3b", base_url: Optional[str] = None, api_key: Optional[str] = None) -> None:
        """
        Initialize Qwen2.5-32B-Instruct API client
        ...
        """
        self.model_path = "qwen2.5-32b-instruct"
